...
public class Startvindu extends JPanel
{
	...
	private JLabel brukerLabel, passLabel, fNavnLabel, eNavnLabel, passord1Label, passord2Label, tlfNrLabel, persNrLabel, adrLabel, postLabel, stedLabel, tekstfelt;
	private JTextField bruker, passord, fNavn, eNavn, persNr, passord1, passord2, tlfNr, adress, postnr, posted, nyttPassord1, nyttPassord2;
	...
	public boolean PassordResatt(Ansatt a, Kunde k)
	{
		if(!(a == null))
		{
			if(a.getResatt() == true)
	...
	public void skiftPassord(Ansatt a, Kunde k)
	{
		nyttPassord1 = new JTextField(20);
		nyttPassord2 = new JTextField(20);
		tekstfelt = new JLabel("");
		tekstfelt.setForeground(Color.red);
		JPanel nyttPass = new JPanel(new GridLayout(6,1));
		nyttPass.add(tekstfelt);
		nyttPass.add(new JLabel("Nytt passord:"));
		nyttPass.add(nyttPassord1);
		nyttPass.add(Box.createHorizontalStrut(15));
		nyttPass.add(new JLabel("Bekreft passord:"));
		nyttPass.add(nyttPassord2);

		JOptionPane.showConfirmDialog(null, nyttPass, "Vennligst skriv inn nytt passord", JOptionPane.OK_CANCEL_OPTION);
		//if(resultat == JOptionPane.OK_OPTION)
		//{
			String p1 = nyttPassord1.getText();
			String p2 = nyttPassord2.getText();
			if(p1.equals("") || p2.equals(""))
				tekstfelt = new JLabel("Du må skrive inn nytt passord");
			else if(!(p1.equals(p2)))
				tekstfelt = new JLabel("Passordene må være like");
			else
			{
				if(!(a == null))
				{
