...
public class KundeGUI extends JPanel
{
	...
	public KundeGUI(Huvudvindu v, Kunde kunn)
	{
		...
		registerGridLeft.add(oppdaterKnapp);
		...
		tabbedPane2.setMnemonicAt(4, KeyEvent.VK_5);
	...
	public BilForsikringsReg biler()
	{
		BilForsikringsReg res = kunde.getBiler();
	...
	public BåtForsikringsReg båter()
	{
		BåtForsikringsReg res = kunde.getBåter();
	...
	public HusForsikringsReg hus()
	{
		HusForsikringsReg res = kunde.getHus();
	...
	public HytteForsikringsReg hytter()
	{
		HytteForsikringsReg res = kunde.getHytter();
	...
	//TODO: Gjør så den finner hvilket vindu som er i fokus
